...
class CarRacing:
    ...
    def run_car(self):
        while True:
            ...
            while not self.crashed:
                ...
                if self.car_x_coordinate < 310:
                    self.car_x_coordinate = 310
                elif self.car_x_coordinate > 460:
                    self.car_x_coordinate = 460
    ...
    def display_credit(self):
        ...
        text = font.render("Sujal kishore kumar talreja", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("sujaltalreja04@gmail.com", True, self.white)
